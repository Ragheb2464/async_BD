...
public:
	...
	void MainLoop(bool aggrClustr, Data_S *data_S, Search_Param	*search_param, int n_sc, int n_workers)
	{ 
	...
	void Cleaning() {cluster_ids.clear(); cluster_ids_before_equalization.clear();} 
};
